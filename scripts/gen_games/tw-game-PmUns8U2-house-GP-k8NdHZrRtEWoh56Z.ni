...
The chamber part 0 is some text that varies. The chamber part 0 is "You arrive in a chamber. An usual kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'

 You can see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is " cuboid locker.[if c_0 is open and there is something in the c_0] The cuboid locker contains [a list of things in the c_0]. You can't wait to tell the folks at home about this![end if]".
The chamber part 2 is some text that varies. The chamber part 2 is "[if c_0 is open and the c_0 contains nothing] The cuboid locker is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The laundry place part 1 is some text that varies. The laundry place part 1 is "[if c_1 is open and the c_1 contains nothing] The safe is empty! What a waste of a day![end if]".
...
The study part 0 is some text that varies. The study part 0 is "You are in a study. An usual one.
 ...
 What's that over there? It looks like it's a table. The table is standard.[if there is something on the s_0] On the table you can make out [a list of things on the s_0].[end if]".
The study part 1 is some text that varies. The study part 1 is "[if there is nothing on the s_0] But the thing is empty, unfortunately. This always happens![end if]".
...
The description of c_0 is "The cuboid locker looks strong, and impossible to force open. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_0 is in r_1.
The c_0 is locked.
The description of c_1 is "The safe looks strong, and impossible to open. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_0 is in r_2.
The f_0 is edible.
The description of k_0 is "The cuboid key is weighty.".
...
The description of o_1 is "The Quote of the Day Calendar looks well matched to everything else here".
...
Test quest0_0 with "go south / take cuboid key / unlock cuboid locker with cuboid key"
...
Rule for printing the banner text:
	...
	say "You are now playing a exciting episode of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to try to go to the south. Okay, and then, pick up the cuboid key in the chamber. Having taken the cuboid key, unlock the cuboid locker in the chamber. Once that's all handled, you can stop![line break]".
...
An objective is some text that varies. The objective is "You are now playing a exciting episode of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to try to go to the south. Okay, and then, pick up the cuboid key in the chamber. Having taken the cuboid key, unlock the cuboid locker in the chamber. Once that's all handled, you can stop!".
